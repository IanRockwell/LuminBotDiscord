...
# Specify the correct path to the 'data.db' file
DB_FILE = '../LuminBot/data.db'

"""
This is an almost identical copy of the data.py
from the LuminBot twitch program, the only thing
modified is the file it's reading from (above).
"""
